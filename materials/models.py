...
class Course(models.Model):
    ...
    owner = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, help_text="Пользователь, который создал курс"
    )
...
class Lesson(models.Model):
    ...
    owner = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, verbose_name="Владелец", help_text="Пользователь, который создал урок"
    )
